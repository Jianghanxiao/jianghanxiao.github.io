...
def parsePubs(segments):
    ...
    for pub in segments["pubs"]:
        ...
        if "github_star" in pub:
            content.append(f"<a href=\"https://github.com/{pub['github_star']}\" target=\"_blank\"> <img src=\"https://img.shields.io/github/stars/{pub['github_star']}.svg?style=social&cacheSeconds=3600\" alt=\"GitHub stars\"></a>")
        if "extra" in pub:
            content.append("<br>")
